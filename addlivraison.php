                ...
                <a href="Listlivraison.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add Livraison </h6>

    <form action="" method="POST">
                    <div class="mb-3">
                    <label class="form-label" for="numCmd">num commande:</label>
                    <input class="form-control" type="text" name="numCmd" id="numCmd" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="prixLiv">prix livraison:</label>
                    <input class="form-control" type="number" name="prixLiv" id="prixLiv" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="adresse">Adresse:</label>
                    <input class="form-control" type="text" name="adresse" id="adresse" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="dateLiv">dateLiv:</label>
                    <input class="form-control" type="date" name="dateLiv" id="dateLiv">
                    </div>
