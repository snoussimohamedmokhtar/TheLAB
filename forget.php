...
if(isset($_POST['forget'])){
	...
	$email = $_POST['adresse'];
		...
		$select = "SELECT * FROM client WHERE adresse = '$email'";
        ...
        $url = 'http://localhost/freshshop-master/changepass.php?id='.$data['idclient'].'&adresse='.$email;
		...
		if ($result == true) {
			...
			$mail->addAddress($email, $data['firstname']);     // Add a recipient
		...
		<form action="" method="post">
			...
			<div class="col-md-12" style="width: 40%">
				...
				<div class="form-group" >
					...
					<input class="form-control" type="email" name="adresse" placeholder="Enter Email">
				</div>
