        ...
        ?>
            ...
            <tbody>
                ...
                <form method="POST" action="updatelivraison.php">
                        ...
                        <input type="hidden" value=<?PHP echo $livraison['idLivreur']; ?> name="idLivreur">
                    </form>
                </td>
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deletelivraison.php?idLivreur=<?php echo $livraison['idLivreur']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
        <?php
