...
<div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <button onclick="window.open('../genererproduit_pdf.php')" class="pdf-button">Générer PDF</button>
        ...
        ?>
          <tbody>
                ...
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deleteproduit.php?idproduit=<?php echo $produit['idproduit']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
