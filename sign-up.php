...
<div class="main-top">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<div class="login-box">
                        <button id="basic" class="selectpicker show-tick form-control" data-placeholder="Sign In"><a href="sign-in.php" style="color: greenyellow;" >Sign IN</a></button>
