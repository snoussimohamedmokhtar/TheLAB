                ...
                <a href="Listcommande.php">back to List</a>
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Add commande </h6>

    <form action="" method="POST">

                    <div class="mb-3">
                    <label class="form-label" for="dateEnvoi">date Envoi:</label>
                    <input class="form-control" type="date" name="dateEnvoi" id="dateEnvoi">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="qnt">Quantite commandes:</label>
                    <input class="form-control" type="text" name="qnt" id="qnt" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="prixCmd">prix commande:</label>
                    <input class="form-control" type="text" name="prixCmd" id="prixCmd" maxlength="20">
                    </div>

                    <div class="mb-3">
                    <label class="form-label" for="idclient">id client:</label>
                    <input class="form-control" type="text" name="idclient" id="idclient" maxlength="20">
                    </div>
