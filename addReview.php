...
<body>
    ...
    <div class="container-fluid pt-4 px-4" >
                <div class="row g-4">
                <a href="Listreview.php">back to List</a>
    ...
    <form action="" method="POST">
                    ...
                    <div class="mb-3">
                    <label class="form-label"for="marque">description:</label>
                    ...
                    <div class="form-group">
                                    <label class="col-md-12" for="pd_img">pd_img:</label>
                                        <div class="col-md-12">
                                            <input type="file" name="pd_img" id="pd-img" placeholder="Enter pd_img "
