...
<div class="container-fluid pt-4 px-4">
                        ...
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            <thead>
                                <tr class="text-white">
                                    ...
                                    <th scope="col">Quantite commandes</th>
          ...
          <tbody>
                ...
                <td align="center">
                    <form method="POST" action="updatecommande.php">
                        ...
                        <input type="hidden" value=<?PHP echo $commande['numCmd']; ?> name="numCmd">
                    </form>
                </td>
                <td  align="center">
                    <a class="btn btn-sm btn-primary" href="deletecommande.php?numCmd=<?php echo $commande['numCmd']; ?>">Delete</a>
                </td>
            </tr>
            </tbody>
    ...
    <form method="post" action="stat.php" align="center">
        <input type="submit" name="stat" value="Statistiques Par Prix" class="button">
    </form>
